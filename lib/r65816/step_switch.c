...
#define opA(id, name)                                   \
    case (0x400 | id): r65816_op_##name(cpu); return;   \
    case (0x300 | id): r65816_op_##name(cpu); return;   \
    case (0x200 | id): r65816_op_##name(cpu); return;   \
    case (0x100 | id): r65816_op_##name(cpu); return;   \
    case (0x000 | id): r65816_op_##name(cpu); return;   \

#define opE(id, name)                                       \
    case (0x400 | id): r65816_op_##name##_e(cpu); return;   \
    case (0x300 | id): r65816_op_##name##_n(cpu); return;   \
    case (0x200 | id): r65816_op_##name##_n(cpu); return;   \
    case (0x100 | id): r65816_op_##name##_n(cpu); return;   \
    case (0x000 | id): r65816_op_##name##_n(cpu); return;   \

#define opM(id, name)                               \
    case (0x400 | id): r65816_op_##name##_b(cpu); return;   \
    case (0x300 | id): r65816_op_##name##_b(cpu); return;   \
    case (0x200 | id): r65816_op_##name##_b(cpu); return;   \
    case (0x100 | id): r65816_op_##name##_w(cpu); return;   \
    case (0x000 | id): r65816_op_##name##_w(cpu); return;   \

#define opX(id, name)                               \
    case (0x400 | id): r65816_op_##name##_b(cpu); return;   \
    case (0x300 | id): r65816_op_##name##_b(cpu); return;   \
    case (0x200 | id): r65816_op_##name##_w(cpu); return;   \
    case (0x100 | id): r65816_op_##name##_b(cpu); return;   \
    case (0x000 | id): r65816_op_##name##_w(cpu); return;   \
...
void r65816_cpu_step(r65816_cpu_t* cpu) {
    ...
    int switchcase = (cpu->regs.e ? (1 << 10) : ((cpu->regs.p.m << 9) | (cpu->regs.p.x << 8))) | r65816_op_readpc(cpu);
