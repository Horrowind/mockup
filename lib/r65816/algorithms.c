...
inline void op_adc_b(r65816_cpu_t* cpu) {
    int result;
...
inline void op_adc_w(r65816_cpu_t* cpu) {
    int result;
...
inline void op_cmp_w(r65816_cpu_t* cpu) {
...
inline void op_cpx_b(r65816_cpu_t* cpu) {
...
inline void op_cpx_w(r65816_cpu_t* cpu) {
...
inline void op_cpy_b(r65816_cpu_t* cpu) {
...
inline void op_cpy_w(r65816_cpu_t* cpu) {
...
inline void op_eor_b(r65816_cpu_t* cpu) {
    cpu->regs.a.l ^= cpu->rd.l;
    cpu->regs.p.n = cpu->regs.a.l & 0x80;
    cpu->regs.p.z = cpu->regs.a.l == 0;
}

inline void op_eor_w(r65816_cpu_t* cpu) {
    cpu->regs.a.w ^= cpu->rd.w;
    cpu->regs.p.n = cpu->regs.a.w & 0x8000;
    cpu->regs.p.z = cpu->regs.a.w == 0;
}

inline void op_lda_b(r65816_cpu_t* cpu) {
    cpu->regs.a.l = cpu->rd.l;
    cpu->regs.p.n = cpu->regs.a.l & 0x80;
    cpu->regs.p.z = cpu->regs.a.l == 0;
}

inline void op_lda_w(r65816_cpu_t* cpu) {
    cpu->regs.a.w = cpu->rd.w;
    cpu->regs.p.n = cpu->regs.a.w & 0x8000;
    cpu->regs.p.z = cpu->regs.a.w == 0;
}

inline void op_ldx_b(r65816_cpu_t* cpu) {
    cpu->regs.x.l = cpu->rd.l;
    cpu->regs.p.n = cpu->regs.x.l & 0x80;
    cpu->regs.p.z = cpu->regs.x.l == 0;
}

inline void op_ldx_w(r65816_cpu_t* cpu) {
    cpu->regs.x.w = cpu->rd.w;
    cpu->regs.p.n = cpu->regs.x.w & 0x8000;
    cpu->regs.p.z = cpu->regs.x.w == 0;
}

inline void op_ldy_b(r65816_cpu_t* cpu) {
    cpu->regs.y.l = cpu->rd.l;
    cpu->regs.p.n = cpu->regs.y.l & 0x80;
    cpu->regs.p.z = cpu->regs.y.l == 0;
}

inline void op_ldy_w(r65816_cpu_t* cpu) {
    cpu->regs.y.w = cpu->rd.w;
    cpu->regs.p.n = cpu->regs.y.w & 0x8000;
    cpu->regs.p.z = cpu->regs.y.w == 0;
}

inline void op_ora_b(r65816_cpu_t* cpu) {
    cpu->regs.a.l |= cpu->rd.l;
    cpu->regs.p.n = cpu->regs.a.l & 0x80;
    cpu->regs.p.z = cpu->regs.a.l == 0;
}

inline void op_ora_w(r65816_cpu_t* cpu) {
    cpu->regs.a.w |= cpu->rd.w;
    cpu->regs.p.n = cpu->regs.a.w & 0x8000;
    cpu->regs.p.z = cpu->regs.a.w == 0;
}

inline void op_sbc_b(r65816_cpu_t* cpu) {
    int result;
    cpu->rd.l ^= 0xff;
...
inline void op_sbc_w(r65816_cpu_t* cpu) {
    int result;
    cpu->rd.w ^= 0xffff;
...
inline void op_inc_b(r65816_cpu_t* cpu) {
    cpu->rd.l++;
    cpu->regs.p.n = cpu->rd.l & 0x80;
    cpu->regs.p.z = cpu->rd.l == 0;
}

inline void op_inc_w(r65816_cpu_t* cpu) {
    cpu->rd.w++;
    cpu->regs.p.n = cpu->rd.w & 0x8000;
    cpu->regs.p.z = cpu->rd.w == 0;
}

inline void op_dec_b(r65816_cpu_t* cpu) {
    cpu->rd.l--;
    cpu->regs.p.n = cpu->rd.l & 0x80;
    cpu->regs.p.z = cpu->rd.l == 0;
}

inline void op_dec_w(r65816_cpu_t* cpu) {
    cpu->rd.w--;
    cpu->regs.p.n = cpu->rd.w & 0x8000;
    cpu->regs.p.z = cpu->rd.w == 0;
}

inline void op_asl_b(r65816_cpu_t* cpu) {
...
inline void op_asl_w(r65816_cpu_t* cpu) {
...
inline void op_lsr_b(r65816_cpu_t* cpu) {
...
inline void op_lsr_w(r65816_cpu_t* cpu) {
...
inline void op_rol_b(r65816_cpu_t* cpu) {
...
inline void op_rol_w(r65816_cpu_t* cpu) {
    unsigned carry = (unsigned)cpu->regs.p.c;
    cpu->regs.p.c = cpu->rd.w & 0x8000;
...
inline void op_ror_b(r65816_cpu_t* cpu) {
...
inline void op_ror_w(r65816_cpu_t* cpu) {
...
inline void op_trb_b(r65816_cpu_t* cpu) {
    cpu->regs.p.z = (cpu->rd.l & cpu->regs.a.l) == 0;
    cpu->rd.l &= ~cpu->regs.a.l;
}

inline void op_trb_w(r65816_cpu_t* cpu) {
    cpu->regs.p.z = (cpu->rd.w & cpu->regs.a.w) == 0;
    cpu->rd.w &= ~cpu->regs.a.w;
}

inline void op_tsb_b(r65816_cpu_t* cpu) {
    cpu->regs.p.z = (cpu->rd.l & cpu->regs.a.l) == 0;
    cpu->rd.l |= cpu->regs.a.l;
}

inline void op_tsb_w(r65816_cpu_t* cpu) {
    cpu->regs.p.z = (cpu->rd.w & cpu->regs.a.w) == 0;
    cpu->rd.w |= cpu->regs.a.w;
}
