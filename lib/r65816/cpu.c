...
void r65816_breakpoint_add_exec(r65816_cpu_t* cpu, uint32_t addr) {
    ...
    bp->address = addr;
    bp->next = cpu->first_breakpoint_exec;
    cpu->first_breakpoint_exec = bp;
}

void r65816_breakpoint_add_read(r65816_cpu_t* cpu, uint32_t addr) {
    r65816_breakpoint_t* bp = malloc(sizeof(r65816_breakpoint_t));
    bp->address = addr;
    bp->next = cpu->first_breakpoint_read;
    cpu->first_breakpoint_read = bp;
}

void r65816_breakpoint_add_write(r65816_cpu_t* cpu, uint32_t addr) {
    r65816_breakpoint_t* bp = malloc(sizeof(r65816_breakpoint_t));
    bp->address = addr;
    bp->next = cpu->first_breakpoint_write;
    cpu->first_breakpoint_write = bp;
}
...
uint8_t r65816_cpu_read(r65816_cpu_t* cpu, uint32_t addr) {
    cpu->stop_execution |= r65816_breakpoint_is_hit(
        cpu->first_breakpoint_read, addr);
...
void r65816_cpu_write(r65816_cpu_t* cpu, uint32_t addr, uint8_t data) {
    cpu->stop_execution |= r65816_breakpoint_is_hit(
        cpu->first_breakpoint_write, addr);
...
void r65816_cpu_disassemble_opcode(r65816_cpu_t* cpu, char* output, uint32_t addr) {
  ...
  case 0x01: sprintf(t, "ora ($%.2x,x)   [%.6x]", op8, r65816_decode(cpu, OPTYPE_IDPX, op8)); break;
  case 0x02: sprintf(t, "cop #$%.2x              ", op8); break;
  case 0x03: sprintf(t, "ora $%.2x,s     [%.6x]", op8, r65816_decode(cpu, OPTYPE_SR, op8)); break;
  case 0x04: sprintf(t, "tsb $%.2x       [%.6x]", op8, r65816_decode(cpu, OPTYPE_DP, op8)); break;
  case 0x05: sprintf(t, "ora $%.2x       [%.6x]", op8, r65816_decode(cpu, OPTYPE_DP, op8)); break;
  case 0x06: sprintf(t, "asl $%.2x       [%.6x]", op8, r65816_decode(cpu, OPTYPE_DP, op8)); break;
  case 0x07: sprintf(t, "ora [$%.2x]     [%.6x]", op8, r65816_decode(cpu, OPTYPE_ILDP, op8)); break;
  ...
  case 0x0c: sprintf(t, "tsb $%.4x     [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDR, op16)); break;
  ...
  case 0x14: sprintf(t, "trb $%.2x       [%.6x]", op8, r65816_decode(cpu, OPTYPE_DP, op8)); break;
  case 0x15: sprintf(t, "ora $%.2x,x     [%.6x]", op8, r65816_decode(cpu, OPTYPE_DPX, op8)); break;
  case 0x16: sprintf(t, "asl $%.2x,x     [%.6x]", op8, r65816_decode(cpu, OPTYPE_DPX, op8)); break;
  case 0x17: sprintf(t, "ora [$%.2x],y   [%.6x]", op8, r65816_decode(cpu, OPTYPE_ILDPY, op8)); break;
  case 0x18: sprintf(t, "clc                   "); break;
  case 0x19: sprintf(t, "ora $%.4x,y   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRY, op16)); break;
  case 0x1a: sprintf(t, "inc                   "); break;
  case 0x1b: sprintf(t, "tcs                   "); break;
  case 0x1c: sprintf(t, "trb $%.4x     [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDR, op16)); break;
  case 0x1d: sprintf(t, "ora $%.4x,x   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRX, op16)); break;
  case 0x1e: sprintf(t, "asl $%.4x,x   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRX, op16)); break;
  case 0x1f: sprintf(t, "ora $%.6x,x [%.6x]", op24, r65816_decode(cpu, OPTYPE_LONGX, op24)); break;
  case 0x20: sprintf(t, "jsr $%.4x     [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDR_PC, op16)); break;
  case 0x21: sprintf(t, "and ($%.2x,x)   [%.6x]", op8, r65816_decode(cpu, OPTYPE_IDPX, op8)); break;
  case 0x22: sprintf(t, "jsl $%.6x   [%.6x]", op24, r65816_decode(cpu, OPTYPE_LONG, op24)); break;
  case 0x23: sprintf(t, "and $%.2x,s     [%.6x]", op8, r65816_decode(cpu, OPTYPE_SR, op8)); break;
  case 0x24: sprintf(t, "bit $%.2x       [%.6x]", op8, r65816_decode(cpu, OPTYPE_DP, op8)); break;
  case 0x25: sprintf(t, "and $%.2x       [%.6x]", op8, r65816_decode(cpu, OPTYPE_DP, op8)); break;
  case 0x26: sprintf(t, "rol $%.2x       [%.6x]", op8, r65816_decode(cpu, OPTYPE_DP, op8)); break;
  case 0x27: sprintf(t, "and [$%.2x]     [%.6x]", op8, r65816_decode(cpu, OPTYPE_ILDP, op8)); break;
  ...
  case 0x2c: sprintf(t, "bit $%.4x     [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDR, op16)); break;
  ...
  case 0x34: sprintf(t, "bit $%.2x,x     [%.6x]", op8, r65816_decode(cpu, OPTYPE_DPX, op8)); break;
  case 0x35: sprintf(t, "and $%.2x,x     [%.6x]", op8, r65816_decode(cpu, OPTYPE_DPX, op8)); break;
  case 0x36: sprintf(t, "rol $%.2x,x     [%.6x]", op8, r65816_decode(cpu, OPTYPE_DPX, op8)); break;
  case 0x37: sprintf(t, "and [$%.2x],y   [%.6x]", op8, r65816_decode(cpu, OPTYPE_ILDPY, op8)); break;
  case 0x38: sprintf(t, "sec                   "); break;
  case 0x39: sprintf(t, "and $%.4x,y   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRY, op16)); break;
  case 0x3a: sprintf(t, "dec                   "); break;
  case 0x3b: sprintf(t, "tsc                   "); break;
  case 0x3c: sprintf(t, "bit $%.4x,x   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRX, op16)); break;
  case 0x3d: sprintf(t, "and $%.4x,x   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRX, op16)); break;
  case 0x3e: sprintf(t, "rol $%.4x,x   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRX, op16)); break;
  case 0x3f: sprintf(t, "and $%.6x,x [%.6x]", op24, r65816_decode(cpu, OPTYPE_LONGX, op24)); break;
  case 0x40: sprintf(t, "rti                   "); break;
  case 0x41: sprintf(t, "eor ($%.2x,x)   [%.6x]", op8, r65816_decode(cpu, OPTYPE_IDPX, op8)); break;
  case 0x42: sprintf(t, "wdm                   "); break;
  case 0x43: sprintf(t, "eor $%.2x,s     [%.6x]", op8, r65816_decode(cpu, OPTYPE_SR, op8)); break;
  case 0x44: sprintf(t, "mvp $%.2x,$%.2x           ", op1, op8); break;
  case 0x45: sprintf(t, "eor $%.2x       [%.6x]", op8, r65816_decode(cpu, OPTYPE_DP, op8)); break;
  case 0x46: sprintf(t, "lsr $%.2x       [%.6x]", op8, r65816_decode(cpu, OPTYPE_DP, op8)); break;
  case 0x47: sprintf(t, "eor [$%.2x]     [%.6x]", op8, r65816_decode(cpu, OPTYPE_ILDP, op8)); break;
  ...
  case 0x4c: sprintf(t, "jmp $%.4x     [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDR_PC, op16)); break;
  ...
  case 0x55: sprintf(t, "eor $%.2x,x     [%.6x]", op8, r65816_decode(cpu, OPTYPE_DPX, op8)); break;
  case 0x56: sprintf(t, "lsr $%.2x,x     [%.6x]", op8, r65816_decode(cpu, OPTYPE_DPX, op8)); break;
  case 0x57: sprintf(t, "eor [$%.2x],y   [%.6x]", op8, r65816_decode(cpu, OPTYPE_ILDPY, op8)); break;
  case 0x58: sprintf(t, "cli                   "); break;
  case 0x59: sprintf(t, "eor $%.4x,y   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRY, op16)); break;
  case 0x5a: sprintf(t, "phy                   "); break;
  case 0x5b: sprintf(t, "tcd                   "); break;
  case 0x5c: sprintf(t, "jml $%.6x   [%.6x]", op24, r65816_decode(cpu, OPTYPE_LONG, op24)); break;
  case 0x5d: sprintf(t, "eor $%.4x,x   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRX, op16)); break;
  case 0x5e: sprintf(t, "lsr $%.4x,x   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRX, op16)); break;
  case 0x5f: sprintf(t, "eor $%.6x,x [%.6x]", op24, r65816_decode(cpu, OPTYPE_LONGX, op24)); break;
  case 0x60: sprintf(t, "rts                   "); break;
  case 0x61: sprintf(t, "adc ($%.2x,x)   [%.6x]", op8, r65816_decode(cpu, OPTYPE_IDPX, op8)); break;
  case 0x62: sprintf(t, "per $%.4x     [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDR, op16)); break;
  case 0x63: sprintf(t, "adc $%.2x,s     [%.6x]", op8, r65816_decode(cpu, OPTYPE_SR, op8)); break;
  case 0x64: sprintf(t, "stz $%.2x       [%.6x]", op8, r65816_decode(cpu, OPTYPE_DP, op8)); break;
  case 0x65: sprintf(t, "adc $%.2x       [%.6x]", op8, r65816_decode(cpu, OPTYPE_DP, op8)); break;
  case 0x66: sprintf(t, "ror $%.2x       [%.6x]", op8, r65816_decode(cpu, OPTYPE_DP, op8)); break;
  case 0x67: sprintf(t, "adc [$%.2x]     [%.6x]", op8, r65816_decode(cpu, OPTYPE_ILDP, op8)); break;
  ...
  case 0x6c: sprintf(t, "jmp ($%.4x)   [%.6x]", op16, r65816_decode(cpu, OPTYPE_IADDR_PC, op16)); break;
  ...
  case 0x74: sprintf(t, "stz $%.2x,x     [%.6x]", op8, r65816_decode(cpu, OPTYPE_DPX, op8)); break;
  case 0x75: sprintf(t, "adc $%.2x,x     [%.6x]", op8, r65816_decode(cpu, OPTYPE_DPX, op8)); break;
  case 0x76: sprintf(t, "ror $%.2x,x     [%.6x]", op8, r65816_decode(cpu, OPTYPE_DPX, op8)); break;
  case 0x77: sprintf(t, "adc [$%.2x],y   [%.6x]", op8, r65816_decode(cpu, OPTYPE_ILDPY, op8)); break;
  case 0x78: sprintf(t, "sei                   "); break;
  case 0x79: sprintf(t, "adc $%.4x,y   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRY, op16)); break;
  case 0x7a: sprintf(t, "ply                   "); break;
  case 0x7b: sprintf(t, "tdc                   "); break;
  case 0x7c: sprintf(t, "jmp ($%.4x,x) [%.6x]", op16, r65816_decode(cpu, OPTYPE_IADDRX, op16)); break;
  ...
  case 0x86: sprintf(t, "stx $%.2x       [%.6x]", op8, r65816_decode(cpu, OPTYPE_DP, op8)); break;
  case 0x87: sprintf(t, "sta [$%.2x]     [%.6x]", op8, r65816_decode(cpu, OPTYPE_ILDP, op8)); break;
  ...
  case 0x8c: sprintf(t, "sty $%.4x     [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDR, op16)); break;
  ...
  case 0x94: sprintf(t, "sty $%.2x,x     [%.6x]", op8, r65816_decode(cpu, OPTYPE_DPX, op8)); break;
  case 0x95: sprintf(t, "sta $%.2x,x     [%.6x]", op8, r65816_decode(cpu, OPTYPE_DPX, op8)); break;
  case 0x96: sprintf(t, "stx $%.2x,y     [%.6x]", op8, r65816_decode(cpu, OPTYPE_DPY, op8)); break;
  case 0x97: sprintf(t, "sta [$%.2x],y   [%.6x]", op8, r65816_decode(cpu, OPTYPE_ILDPY, op8)); break;
  case 0x98: sprintf(t, "tya                   "); break;
  case 0x99: sprintf(t, "sta $%.4x,y   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRY, op16)); break;
  case 0x9a: sprintf(t, "txs                   "); break;
  case 0x9b: sprintf(t, "txy                   "); break;
  case 0x9c: sprintf(t, "stz $%.4x     [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDR, op16)); break;
  case 0x9d: sprintf(t, "sta $%.4x,x   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRX, op16)); break;
  case 0x9e: sprintf(t, "stz $%.4x,x   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRX, op16)); break;
  case 0x9f: sprintf(t, "sta $%.6x,x [%.6x]", op24, r65816_decode(cpu, OPTYPE_LONGX, op24)); break;
  case 0xa0: if(x8)sprintf(t, "ldy #$%.2x              ", op8);
             else  sprintf(t, "ldy #$%.4x            ", op16); break;
  case 0xa1: sprintf(t, "lda ($%.2x,x)   [%.6x]", op8, r65816_decode(cpu, OPTYPE_IDPX, op8)); break;
  case 0xa2: if(x8)sprintf(t, "ldx #$%.2x              ", op8);
             else  sprintf(t, "ldx #$%.4x            ", op16); break;
  case 0xa3: sprintf(t, "lda $%.2x,s     [%.6x]", op8, r65816_decode(cpu, OPTYPE_SR, op8)); break;
  case 0xa4: sprintf(t, "ldy $%.2x       [%.6x]", op8, r65816_decode(cpu, OPTYPE_DP, op8)); break;
  case 0xa5: sprintf(t, "lda $%.2x       [%.6x]", op8, r65816_decode(cpu, OPTYPE_DP, op8)); break;
  case 0xa6: sprintf(t, "ldx $%.2x       [%.6x]", op8, r65816_decode(cpu, OPTYPE_DP, op8)); break;
  case 0xa7: sprintf(t, "lda [$%.2x]     [%.6x]", op8, r65816_decode(cpu, OPTYPE_ILDP, op8)); break;
  ...
  case 0xac: sprintf(t, "ldy $%.4x     [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDR, op16)); break;
  ...
  case 0xb4: sprintf(t, "ldy $%.2x,x     [%.6x]", op8, r65816_decode(cpu, OPTYPE_DPX, op8)); break;
  case 0xb5: sprintf(t, "lda $%.2x,x     [%.6x]", op8, r65816_decode(cpu, OPTYPE_DPX, op8)); break;
  case 0xb6: sprintf(t, "ldx $%.2x,y     [%.6x]", op8, r65816_decode(cpu, OPTYPE_DPY, op8)); break;
  case 0xb7: sprintf(t, "lda [$%.2x],y   [%.6x]", op8, r65816_decode(cpu, OPTYPE_ILDPY, op8)); break;
  case 0xb8: sprintf(t, "clv                   "); break;
  case 0xb9: sprintf(t, "lda $%.4x,y   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRY, op16)); break;
  case 0xba: sprintf(t, "tsx                   "); break;
  case 0xbb: sprintf(t, "tyx                   "); break;
  case 0xbc: sprintf(t, "ldy $%.4x,x   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRX, op16)); break;
  case 0xbd: sprintf(t, "lda $%.4x,x   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRX, op16)); break;
  case 0xbe: sprintf(t, "ldx $%.4x,y   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRY, op16)); break;
  case 0xbf: sprintf(t, "lda $%.6x,x [%.6x]", op24, r65816_decode(cpu, OPTYPE_LONGX, op24)); break;
  case 0xc0: if(x8)sprintf(t, "cpy #$%.2x              ", op8);
             else  sprintf(t, "cpy #$%.4x            ", op16); break;
  case 0xc1: sprintf(t, "cmp ($%.2x,x)   [%.6x]", op8, r65816_decode(cpu, OPTYPE_IDPX, op8)); break;
  case 0xc2: sprintf(t, "rep #$%.2x              ", op8); break;
  case 0xc3: sprintf(t, "cmp $%.2x,s     [%.6x]", op8, r65816_decode(cpu, OPTYPE_SR, op8)); break;
  case 0xc4: sprintf(t, "cpy $%.2x       [%.6x]", op8, r65816_decode(cpu, OPTYPE_DP, op8)); break;
  case 0xc5: sprintf(t, "cmp $%.2x       [%.6x]", op8, r65816_decode(cpu, OPTYPE_DP, op8)); break;
  case 0xc6: sprintf(t, "dec $%.2x       [%.6x]", op8, r65816_decode(cpu, OPTYPE_DP, op8)); break;
  case 0xc7: sprintf(t, "cmp [$%.2x]     [%.6x]", op8, r65816_decode(cpu, OPTYPE_ILDP, op8)); break;
  ...
  case 0xcc: sprintf(t, "cpy $%.4x     [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDR, op16)); break;
  ...
  case 0xd4: sprintf(t, "pei ($%.2x)     [%.6x]", op8, r65816_decode(cpu, OPTYPE_IDP, op8)); break;
  case 0xd5: sprintf(t, "cmp $%.2x,x     [%.6x]", op8, r65816_decode(cpu, OPTYPE_DPX, op8)); break;
  case 0xd6: sprintf(t, "dec $%.2x,x     [%.6x]", op8, r65816_decode(cpu, OPTYPE_DPX, op8)); break;
  case 0xd7: sprintf(t, "cmp [$%.2x],y   [%.6x]", op8, r65816_decode(cpu, OPTYPE_ILDPY, op8)); break;
  case 0xd8: sprintf(t, "cld                   "); break;
  case 0xd9: sprintf(t, "cmp $%.4x,y   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRY, op16)); break;
  case 0xda: sprintf(t, "phx                   "); break;
  case 0xdb: sprintf(t, "stp                   "); break;
  case 0xdc: sprintf(t, "jmp [$%.4x]   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ILADDR, op16)); break;
  case 0xdd: sprintf(t, "cmp $%.4x,x   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRX, op16)); break;
  case 0xde: sprintf(t, "dec $%.4x,x   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRX, op16)); break;
  case 0xdf: sprintf(t, "cmp $%.6x,x [%.6x]", op24, r65816_decode(cpu, OPTYPE_LONGX, op24)); break;
  case 0xe0: if(x8)sprintf(t, "cpx #$%.2x              ", op8);
             else  sprintf(t, "cpx #$%.4x            ", op16); break;
  case 0xe1: sprintf(t, "sbc ($%.2x,x)   [%.6x]", op8, r65816_decode(cpu, OPTYPE_IDPX, op8)); break;
  case 0xe2: sprintf(t, "sep #$%.2x              ", op8); break;
  case 0xe3: sprintf(t, "sbc $%.2x,s     [%.6x]", op8, r65816_decode(cpu, OPTYPE_SR, op8)); break;
  case 0xe4: sprintf(t, "cpx $%.2x       [%.6x]", op8, r65816_decode(cpu, OPTYPE_DP, op8)); break;
  case 0xe5: sprintf(t, "sbc $%.2x       [%.6x]", op8, r65816_decode(cpu, OPTYPE_DP, op8)); break;
  case 0xe6: sprintf(t, "inc $%.2x       [%.6x]", op8, r65816_decode(cpu, OPTYPE_DP, op8)); break;
  case 0xe7: sprintf(t, "sbc [$%.2x]     [%.6x]", op8, r65816_decode(cpu, OPTYPE_ILDP, op8)); break;
  ...
  case 0xec: sprintf(t, "cpx $%.4x     [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDR, op16)); break;
  ...
  case 0xf4: sprintf(t, "pea $%.4x     [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDR, op16)); break;
  case 0xf5: sprintf(t, "sbc $%.2x,x     [%.6x]", op8, r65816_decode(cpu, OPTYPE_DPX, op8)); break;
  case 0xf6: sprintf(t, "inc $%.2x,x     [%.6x]", op8, r65816_decode(cpu, OPTYPE_DPX, op8)); break;
  case 0xf7: sprintf(t, "sbc [$%.2x],y   [%.6x]", op8, r65816_decode(cpu, OPTYPE_ILDPY, op8)); break;
  case 0xf8: sprintf(t, "sed                   "); break;
  case 0xf9: sprintf(t, "sbc $%.4x,y   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRY, op16)); break;
  case 0xfa: sprintf(t, "plx                   "); break;
  case 0xfb: sprintf(t, "xce                   "); break;
  case 0xfc: sprintf(t, "jsr ($%.4x,x) [%.6x]", op16, r65816_decode(cpu, OPTYPE_IADDRX, op16)); break;
  case 0xfd: sprintf(t, "sbc $%.4x,x   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRX, op16)); break;
  case 0xfe: sprintf(t, "inc $%.4x,x   [%.6x]", op16, r65816_decode(cpu, OPTYPE_ADDRX, op16)); break;
  case 0xff: sprintf(t, "sbc $%.6x,x [%.6x]", op24, r65816_decode(cpu, OPTYPE_LONGX, op24)); break;
  }
