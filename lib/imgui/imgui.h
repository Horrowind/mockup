...
namespace ImGui
{
    ...
    IMGUI_API bool          DragUChar(const char* label, unsigned char* v, float v_speed = 1.0f, unsigned char v_min = 0, unsigned char v_max = 0, const char* display_format = "%.0f");                                       // If v_min >= v_max we have no bound
    IMGUI_API bool          DragUShort(const char* label, unsigned short* v, float v_speed = 1.0f, unsigned short v_min = 0, unsigned short v_max = 0, const char* display_format = "%.0f");                                       // If v_min >= v_max we have no bound
