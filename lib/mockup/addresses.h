...
const u32 level_load_objects_routine_end_sfc =  0x058091;
const u32 level_load_objects_routine_end2_sfc = 0x0586E2;
const u32 level_load_objects_routine_end3_sfc = 0x058416;
const u32 level_load_objects_routine_new_object_sfc =  0x0586C5;
...
const u32 level_objects_low_start_sfc  = 0x7EC800;
const u32 level_objects_low_end_sfc  = 0x7EFFFF;
const u32 level_objects_high_start_sfc  = 0x7FC800;
const u32 level_objects_high_end_sfc  = 0x7FFFFF;
