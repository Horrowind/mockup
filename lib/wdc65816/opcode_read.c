...
#define wdc65816_op_read_const_gen(op)                        \
    void wdc65816_op_read_const_##op##_b(wdc65816_cpu_t* cpu) { \
        cpu->rd.l = wdc65816_op_readpc(cpu);                  \
        wdc65816_op_##op##_b(cpu);                            \
    }                                                       \
                                                            \
    void wdc65816_op_read_const_##op##_w(wdc65816_cpu_t* cpu) { \
        cpu->rd.l = wdc65816_op_readpc(cpu);                  \
...
#define wdc65816_op_read_addr_gen(op)                         \
    void wdc65816_op_read_addr_##op##_b(wdc65816_cpu_t* cpu) {  \
        ...
        wdc65816_op_##op##_b(cpu);                            \
                                                            ...
                                                            \
    void wdc65816_op_read_addr_##op##_w(wdc65816_cpu_t* cpu) {  \
        cpu->aa.l = wdc65816_op_readpc(cpu);                  \
        cpu->aa.h = wdc65816_op_readpc(cpu);                  \
...
#define wdc65816_op_read_addrx_gen(op)                                    \
    void wdc65816_op_read_addrx_##op##_b(wdc65816_cpu_t* cpu) {             \
        cpu->aa.l = wdc65816_op_readpc(cpu);                              \
        cpu->aa.h = wdc65816_op_readpc(cpu);                              \
        ...
        wdc65816_op_##op##_b(cpu);                                        \
                                                                        ...
                                                                        \
    void wdc65816_op_read_addrx_##op##_w(wdc65816_cpu_t* cpu) {             \
        cpu->aa.l = wdc65816_op_readpc(cpu);                              \
        cpu->aa.h = wdc65816_op_readpc(cpu);                              \
...
#define wdc65816_op_read_addry_gen(op)                                    \
    void wdc65816_op_read_addry_##op##_b(wdc65816_cpu_t* cpu) {             \
        cpu->aa.l = wdc65816_op_readpc(cpu);                              \
        cpu->aa.h = wdc65816_op_readpc(cpu);                              \
        ...
        wdc65816_op_##op##_b(cpu);                                        \
                                                                        ...
                                                                        \
    void wdc65816_op_read_addry_##op##_w(wdc65816_cpu_t* cpu) {             \
        cpu->aa.l = wdc65816_op_readpc(cpu);                              \
        cpu->aa.h = wdc65816_op_readpc(cpu);                              \
...
#define wdc65816_op_read_long_gen(op)                         \
    void wdc65816_op_read_long_##op##_b(wdc65816_cpu_t* cpu) {  \
        cpu->aa.l = wdc65816_op_readpc(cpu);                  \
        cpu->aa.h = wdc65816_op_readpc(cpu);                  \
        ...
        wdc65816_op_##op##_b(cpu);                            \
                                                            ...
                                                            \
    void wdc65816_op_read_long_##op##_w(wdc65816_cpu_t* cpu) {  \
        cpu->aa.l = wdc65816_op_readpc(cpu);                  \
        cpu->aa.h = wdc65816_op_readpc(cpu);                  \
        cpu->aa.b = wdc65816_op_readpc(cpu);                  \
...
#define wdc65816_op_read_longx_gen(op)                                    \
    void wdc65816_op_read_longx_##op##_b(wdc65816_cpu_t* cpu) {             \
        cpu->aa.l = wdc65816_op_readpc(cpu);                              \
        cpu->aa.h = wdc65816_op_readpc(cpu);                              \
        cpu->aa.b = wdc65816_op_readpc(cpu);                              \
        ...
        wdc65816_op_##op##_b(cpu);                                        \
                                                                        ...
                                                                        \
    void wdc65816_op_read_longx_##op##_w(wdc65816_cpu_t* cpu) {             \
        cpu->aa.l = wdc65816_op_readpc(cpu);                              \
        cpu->aa.h = wdc65816_op_readpc(cpu);                              \
        cpu->aa.b = wdc65816_op_readpc(cpu);                              \
...
#define wdc65816_op_read_dp_gen(op)                                       \
    void wdc65816_op_read_dp_##op##_b(wdc65816_cpu_t* cpu) {                \
        cpu->dp = wdc65816_op_readpc(cpu);                                \
        cpu->rd.l = wdc65816_op_readdp(cpu, cpu->dp);                     \
        wdc65816_op_##op##_b(cpu);                                        \
    }                                                                   \
                                                                        \
    void wdc65816_op_read_dp_##op##_w(wdc65816_cpu_t* cpu) {                \
        cpu->dp = wdc65816_op_readpc(cpu);                                \
...
#define wdc65816_op_read_dpr_gen(op, num)                                 \
    void wdc65816_op_read_dpr_##op##_b(wdc65816_cpu_t* cpu) {               \
        cpu->dp = wdc65816_op_readpc(cpu);                                \
        cpu->rd.l = wdc65816_op_readdp(cpu, cpu->dp + cpu->regs.r[num].w); \
        wdc65816_op_##op##_b(cpu);                                        \
    }                                                                   \
                                                                        \
    void wdc65816_op_read_dpr_##op##_w(wdc65816_cpu_t* cpu) {               \
        cpu->dp = wdc65816_op_readpc(cpu);                                \
...
#define wdc65816_op_read_idp_gen(op)                                      \
    void wdc65816_op_read_idp_##op##_b(wdc65816_cpu_t* cpu) {               \
        cpu->dp = wdc65816_op_readpc(cpu);                                \
        ...
        wdc65816_op_##op##_b(cpu);                                        \
                                                                        ...
                                                                        \
    void wdc65816_op_read_idp_##op##_w(wdc65816_cpu_t* cpu) {               \
        cpu->dp = wdc65816_op_readpc(cpu);                                \
        cpu->aa.l = wdc65816_op_readdp(cpu, cpu->dp + 0);                 \
        cpu->aa.h = wdc65816_op_readdp(cpu, cpu->dp + 1);                 \
        cpu->rd.l = wdc65816_op_readdbr(cpu, cpu->aa.w + 0);              \
...
#define wdc65816_op_read_idpx_gen(op)                                     \
    void wdc65816_op_read_idpx_##op##_b(wdc65816_cpu_t* cpu) {              \
        cpu->dp = wdc65816_op_readpc(cpu);                                \
        ...
        wdc65816_op_##op##_b(cpu);                                        \
                                                                        ...
                                                                        \
    void wdc65816_op_read_idpx_##op##_w(wdc65816_cpu_t* cpu) {              \
        cpu->dp = wdc65816_op_readpc(cpu);                                \
        cpu->aa.l = wdc65816_op_readdp(cpu, cpu->dp + cpu->regs.x.w + 0); \
        cpu->aa.h = wdc65816_op_readdp(cpu, cpu->dp + cpu->regs.x.w + 1); \
        cpu->rd.l = wdc65816_op_readdbr(cpu, cpu->aa.w + 0);              \
...
#define wdc65816_op_read_idpy_gen(op)                                     \
    void wdc65816_op_read_idpy_##op##_b(wdc65816_cpu_t* cpu) {              \
        cpu->dp = wdc65816_op_readpc(cpu);                                \
        cpu->aa.l = wdc65816_op_readdp(cpu, cpu->dp + 0);                 \
        cpu->aa.h = wdc65816_op_readdp(cpu, cpu->dp + 1);                 \
        cpu->rd.l = wdc65816_op_readdbr(cpu, cpu->aa.w + cpu->regs.y.w);  \
        wdc65816_op_##op##_b(cpu);                                        \
                                                                        ...
                                                                        \
    void wdc65816_op_read_idpy_##op##_w(wdc65816_cpu_t* cpu) {              \
        cpu->dp = wdc65816_op_readpc(cpu);                                \
        cpu->aa.l = wdc65816_op_readdp(cpu, cpu->dp + 0);                 \
        cpu->aa.h = wdc65816_op_readdp(cpu, cpu->dp + 1);                 \
        cpu->rd.l = wdc65816_op_readdbr(cpu, cpu->aa.w + cpu->regs.y.w + 0); \
...
#define wdc65816_op_read_ildp_gen(op)                         \
    void wdc65816_op_read_ildp_##op##_b(wdc65816_cpu_t* cpu) {  \
        cpu->dp = wdc65816_op_readpc(cpu);                    \
        cpu->aa.l = wdc65816_op_readdp(cpu, cpu->dp + 0);     \
        cpu->aa.h = wdc65816_op_readdp(cpu, cpu->dp + 1);     \
        ...
        wdc65816_op_##op##_b(cpu);                            \
                                                            ...
                                                            \
    void wdc65816_op_read_ildp_##op##_w(wdc65816_cpu_t* cpu) {  \
        cpu->dp = wdc65816_op_readpc(cpu);                    \
        cpu->aa.l = wdc65816_op_readdp(cpu, cpu->dp + 0);     \
        cpu->aa.h = wdc65816_op_readdp(cpu, cpu->dp + 1);     \
        cpu->aa.b = wdc65816_op_readdp(cpu, cpu->dp + 2);     \
...
#define wdc65816_op_read_ildpy_gen(op)                                    \
    void wdc65816_op_read_ildpy_##op##_b(wdc65816_cpu_t* cpu) {             \
        cpu->dp = wdc65816_op_readpc(cpu);                                \
        cpu->aa.l = wdc65816_op_readdp(cpu, cpu->dp + 0);                 \
        cpu->aa.h = wdc65816_op_readdp(cpu, cpu->dp + 1);                 \
        cpu->aa.b = wdc65816_op_readdp(cpu, cpu->dp + 2);                 \
        ...
        wdc65816_op_##op##_b(cpu);                                        \
                                                                        ...
                                                                        \
    void wdc65816_op_read_ildpy_##op##_w(wdc65816_cpu_t* cpu) {             \
        cpu->dp = wdc65816_op_readpc(cpu);                                \
        cpu->aa.l = wdc65816_op_readdp(cpu, cpu->dp + 0);                 \
        cpu->aa.h = wdc65816_op_readdp(cpu, cpu->dp + 1);                 \
        cpu->aa.b = wdc65816_op_readdp(cpu, cpu->dp + 2);                 \
...
#define wdc65816_op_read_sr_gen(op)                           \
    void wdc65816_op_read_sr_##op##_b(wdc65816_cpu_t* cpu) {    \
        cpu->sp = wdc65816_op_readpc(cpu);                    \
        cpu->rd.l = wdc65816_op_readsp(cpu, cpu->sp);         \
        wdc65816_op_##op##_b(cpu);                            \
    }                                                       \
                                                            \
    void wdc65816_op_read_sr_##op##_w(wdc65816_cpu_t* cpu) {    \
        cpu->sp = wdc65816_op_readpc(cpu);                    \
...
#define wdc65816_op_read_isry_gen(op)                                     \
    void wdc65816_op_read_isry_##op##_b(wdc65816_cpu_t* cpu) {              \
        cpu->sp = wdc65816_op_readpc(cpu);                                \
        ...
        wdc65816_op_##op##_b(cpu);                                        \
                                                                        ...
                                                                        \
    void wdc65816_op_read_isry_##op##_w(wdc65816_cpu_t* cpu) {              \
        cpu->sp = wdc65816_op_readpc(cpu);                                \
        cpu->aa.l = wdc65816_op_readsp(cpu, cpu->sp + 0);                 \
        cpu->aa.h = wdc65816_op_readsp(cpu, cpu->sp + 1);                 \
        cpu->rd.l = wdc65816_op_readdbr(cpu, cpu->aa.w + cpu->regs.y.w + 0); \
